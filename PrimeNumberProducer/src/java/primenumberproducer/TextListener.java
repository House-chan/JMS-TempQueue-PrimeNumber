...
public class TextListener implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            String result = "";
            try{
                textMessage = msg.getText().replaceAll(" ", "").split(",");
                for(String prime: textMessage){
                    result += String.valueOf(isPrime(Integer.parseInt(prime)))+ ", ";
                }
            } catch(Exception e){
                result = Boolean.toString(isPrime(Integer.parseInt(msg.getText())));
            }
